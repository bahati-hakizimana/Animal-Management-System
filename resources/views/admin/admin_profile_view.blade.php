          ...
          <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
            <div class="card rounded">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <label class="tx-11 fw-bolder mb-0 text-uppercase">Phome:</label>
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
								...
								<form method="POST" action="{{route('admin.profile.store')}}" enctype="multpart/form-data" class="forms-sample">
                                @csrf
									<div class="mb-3">
